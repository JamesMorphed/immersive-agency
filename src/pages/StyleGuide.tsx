      ...
      <div className="container mx-auto px-4 pt-32 pb-20">
        ...
        >
          ...
          <Tabs defaultValue="typography" className="w-full mb-20">
            ...
            <TabsContent value="custom-icons" className="space-y-8">
              <div className="grid gap-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  <Card className="bg-black/50 border border-gray-800">
                    <CardContent className="p-6 space-y-6">
                      ...
                      <IconUploader onSuccess={handleIconsRefresh} />
                    </CardContent>
                  </Card>
                ...
                <div className="mt-8">
                  <IconGallery key={`gallery-${refreshCount}`} onRefresh={handleIconsRefresh} />
                </div>
